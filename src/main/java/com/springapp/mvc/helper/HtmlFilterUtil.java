...
public class HtmlFilterUtil {
    ...
    private final static String regxpForTag = "&lt;|&lt|&gt;|&gt|&quot;|&quot|&amp;|&amp|&apos;|&apos"; // 过滤常用的转义标签
    ...
    public static String filterTag(String content) {
        ...
        content = content.replaceAll(regxpForTag, "");
        content = content.replaceAll(regxpForHtml, "");
        return content;
